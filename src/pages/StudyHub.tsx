    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link to="/syllabus" className="sophia-card p-6 hover:shadow-lg transition-shadow">
          ...
          <Link to="/summaries" className="sophia-card p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-4 mb-3">
          ...
          <Link to="/novels" className="sophia-card p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-4 mb-3">
          ...
          <Link to="/videos" className="sophia-card p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-4 mb-3">
