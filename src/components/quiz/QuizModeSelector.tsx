  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <p className="text-gray-600 text-base mb-6">
        Take a full computer-based test simulating real JAMB exam conditions
      </p>

      <div className="mb-6">
        <h3 className="text-xl font-semibold mb-4">JAMB UTME Exam</h3>
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>Note:</strong> After selecting JAMB, you'll choose your class category
