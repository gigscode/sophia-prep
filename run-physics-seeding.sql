-- Run this in Supabase SQL Editor to seed Physics topics
-- Copy and paste the entire content of seed-physics-topics-direct.sql here
...
BEGIN
    ...
    -- Insert Mechanics topics (11 topics)
    ...
    -- Insert Thermal Physics topics (8 topics)
    INSERT INTO topics (subject_id, category_id, name, slug, difficulty_level, estimated_study_time_minutes, sort_order)
    VALUES 
    ...
    -- Insert Waves & Optics topics (8 topics)
    INSERT INTO topics (subject_id, category_id, name, slug, difficulty_level, estimated_study_time_minutes, sort_order)
    VALUES 
    ...
    -- Insert Electricity & Magnetism topics (10 topics)
    INSERT INTO topics (subject_id, category_id, name, slug, difficulty_level, estimated_study_time_minutes, sort_order)
    VALUES 
...
SELECT 'Physics Topics Seeded Successfully! 🎉' as result;