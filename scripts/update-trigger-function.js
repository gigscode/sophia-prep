...
// The old function (without error handling)
const oldFunction = `-- Function to handle new user creation (auto-create user_profiles)
...
if (schemaContent.includes('RETURNS TRIGGER AS $')) {
  ...
  console.log('✗ Function not found in expected format');
}
